    ...
    return(
        <div className="bg-[#1e293b] border-t border-[#2b4161] flex justify-between pt-12 pb-6">
            <div className="flex justify-start items-center gap-4 px-12">
                <Link href={'/login'} className="text-[14px] font-[500] text-[#859fb8] hover:text-[#FFFFFF]">Terms of Use</Link>
                <Link href={'/login'} className="text-[14px] font-[500] text-[#859fb8] hover:text-[#FFFFFF]">Privacy Policy</Link>
            </div>
